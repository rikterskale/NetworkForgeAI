...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--host-execution", action="store_true",
    ...
    parser.add_argument("--provider", choices=["openai", "anthropic", "google", "local", "litellm"],
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.tool:
        tool = get_tool_by_name(args.tool, dry_run=args.dry_run,
                                sandbox_mode=not args.host_execution, scope_policy=policy)
